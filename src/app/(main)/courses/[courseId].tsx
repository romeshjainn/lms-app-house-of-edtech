    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        <View style={styles.heroWrap}>
          <ImageSlider
            images={
              course.images.length > 0 ? course.images : course.thumbnail ? [course.thumbnail] : []
            }
            height={HERO_HEIGHT}
          />
        ...
        <View style={styles.section}>
          ...
          >
            <CustomText
              style={{ fontFamily: FONTS.BOLD, fontSize: FONT_SIZES.XXL, color: colors.PRIMARY }}
            >
        ...
        <View style={styles.section}>
          <CustomText
            style={{ fontFamily: FONTS.BOLD, fontSize: FONT_SIZES.MD, color: colors.TEXT_PRIMARY }}
          >
            About this course
          </CustomText>
          <CustomText
